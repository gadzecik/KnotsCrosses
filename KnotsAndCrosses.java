...
/* Poprawki:
    ...
    */    
    ...
    public static void main(String[] args) {
        ...
        //inna pętla!!... bo potem się gra nie kończy
        for(int i=0;i<5;i++){
            int a = gra.whereX();
            if(gra.checkX(a) && gra.getLiczbaZnakow()<9){
             ...
             //   gra.czyKtosWygral();
               ...
               // gra.czyKtosWygral();
                ...
                i--;
            //u coś dopisać.. żeby sprawdzał, czy tablica jest pełna...!
            }
     //   gra.ktoWygral();    
    ...
    public int whereX(){
        ...
        System.out.println("W jakim polu wstawić X?");
    ...
    public boolean czyDwaX(int[] tab){
        ...
        if(tab.length==9){
            // Sprawdzamy, czy są dwa X w jednym wierszu;
            for(int i=0;i<9;i+=3){
            ...
            //Sprawdzamy, czy są dwa X w jednej kolumnie;        
            for(int i=0;i<3;i++){
            ...
            // Sprawdzamy, czy są dwa X na przekątnej;
    ...
    public boolean czyKrzyz(int[] tab){
        if(tab.length==9){
            ...
            //Jeśli na krzyżu 25846 są dwa krzyżyki w ramionach, to suma tych wyrazów w tabH wynosi co najmniej 20
    ...
    public boolean czySrodek(int[] tab){
        return tab[4]==10;
        //uwaga, w tym przypadku powinien być tylko 1 krzyzyk na tablicy i zadnego kolka
    }
    public boolean czyDwaO(int[] tab){
        // Teraz lamiemy zasadę, żeby nie powtarzać kodu... potem do tego wrócimy
        if(tab.length==9){
            for(int i=0;i<9;i+=3){
    ...
    public void wstawKolko(int i){
        switch(i){
            ...
            //Sprawdzamy, czy są dwa O w jednej kolumnie;        
            for(int a=0;a<3;a++){
            ...
            // Sprawdzamy, czy są dwa O na przekątnej;
            if(tabH[0]+tabH[4]+tabH[8]==1 || tabH[2]+tabH[4]+tabH[6]==1){
                if(tabH[0]==1){
                    tablica[0]=0;
                    tabH[0]=0;
